"""Hexium HTTP header sampler aligned with the device-row network."""

from dataclasses import dataclass
from typing import Any, Dict, Iterable, List, Literal, Optional, Tuple, Union

from hexium_browser.persona.sampler.bayes import BayesianNetwork, get_possible_values
from hexium_browser.persona.sampler.datapoints import (
    get_browser_helper_file,
    get_header_network,
    get_headers_order,
    get_input_network,
)
from hexium_browser.persona.sampler.header_utils import (
    get_browser,
    get_user_agent,
    pascalize_headers,
    tuplify,
...
ListOrString = Union[Tuple[str, ...], List[str], str]
...
class HeaderSampler:
    ...
    def __init__(
        ...
        """
        Initializes the HeaderSampler with the given options.
