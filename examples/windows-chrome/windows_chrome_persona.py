...
Usage:
    python examples/windows-chrome/windows_chrome_persona.py
    python examples/windows-chrome/windows_chrome_persona.py --headed
    python examples/windows-chrome/windows_chrome_persona.py --proxy http://127.0.0.1:8888
    python examples/windows-chrome/windows_chrome_persona.py --twice
"""
