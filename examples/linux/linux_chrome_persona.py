...
Usage:
    ...
    python examples/linux/linux_chrome_persona.py --headed
    python examples/linux/linux_chrome_persona.py --proxy http://127.0.0.1:8888
    python examples/linux/linux_chrome_persona.py --twice
"""
