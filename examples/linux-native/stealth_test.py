...
Usage:
    ...
    python examples/linux-native/stealth_test.py --headed     # watch in real-time
    python examples/linux-native/stealth_test.py --no-screenshots
    python examples/linux-native/stealth_test.py --proxy http://10.50.96.5:8888
"""
